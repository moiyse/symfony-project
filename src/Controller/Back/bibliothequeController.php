...
class bibliothequeController extends AbstractController
{
    ...
    */
     ...
     * @Route("/search/", name="bibliotheque_serie_search")
     */
    public function searchSeries(BibliothequeRepository $bibliothequerepository, Request $request)
    {
        $bib = $bibliothequerepository->findByNamePopular(
            $request->query->get('query')
        );
        

        $entityManager = $this->getDoctrine()->getManager();
        $categoryRepository=$entityManager->getRepository(Bibliotheque::class);
