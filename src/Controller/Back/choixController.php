...
class choixController extends AbstractController
{
    ...
    */
     ...
     *  @param ChoixRepository $repository
     * @Route("/search/", name="choix_serie_search")
     */
    public function searchSeries(ChoixRepository $choixrepository, Request $request)
    {
        ...
        $categoryRepository=$entityManager->getRepository(Choix::class);
